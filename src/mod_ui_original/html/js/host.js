    ...
    if (cmd == "loading_end") {
      ...
      $.ajax({
        ...
        success: function (resp) {
          console.log("DEBUG: Snapshot API response:", resp);
          ...
          if (resp.ok) {
            console.log("DEBUG: Response OK, calling desktop.init()");
          ...
          pb_loading = false;
          desktop.init();
          console.log("DEBUG: desktop.init() called");
        },
        error: function (xhr, status, error) {
          ...
          pb_loading = false;
          desktop.init();
          console.log("DEBUG: desktop.init() called after error");
        },
        cache: false,
        dataType: "json",
      });
